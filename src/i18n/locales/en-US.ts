export default {
  ...
  settings: {
    ...
    update: {
      ...
      sourceDesc: 'Which GitHub mirror to use for checking and downloading. Auto tries them in order.',
      source: 'Source',
      sourceAuto: 'Auto (try in order)',
  ...
  plugins: {
    ...
    rest: {
      ...
      timingSection: 'Reminder preferences',
      timingSectionDesc: 'Set when and how often the sitting reminder fires',
      windowTitle: 'Active duration',
      windowDesc: 'How long of continuous activity before reminding you to rest',
      breakTitle: 'Valid rest duration',
      breakDesc: 'How many consecutive rest minutes count as a valid break',
      snoozeTitle: 'Repeat reminder interval',
      snoozeDesc: 'How often to remind after the active window is reached',
      previewDefaultTitle: 'Rest Reminder',
      previewDefaultBody: 'Stand up and take a break.',
      testBtn: 'Send test reminder',
      methodSection: 'Reminder style',
      contentSection: 'Reminder content',
      contentSectionDesc: 'Customize the title and message shown in the reminder',
      modeTitle: 'Reminder mode',
      ...
      customBody: 'Message',
      customBodyDesc: 'Leave empty to use the default',
      disabledHint: 'Sitting reminder is turned off. Enable it via the top-right switch to configure timing and content.',
      fullscreenBgTitle: 'Fullscreen background',
    ...
    external: {
      ...
      installZip: 'Install from zip...',
      installing: 'Installing…',
      installOk: 'Installed {name} v{version}. Enable it manually.',
      installOverwriteOk: 'Replaced {name} v{version}',
      installOverwriteConfirm:
        'Plugin "{id}" is already installed. Overwrite files? Settings are kept.',
      installFailed: 'Install failed: {error}',
      installCancelled: 'Install cancelled',
      emptyHint: 'Use Install to pick a folder or zip, or drop a package into the plugins folder and refresh.',
      enabled: 'Enabled',
      disabled: 'Disabled',
      anomalous: 'Anomalous',
