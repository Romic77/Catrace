export default {
  ...
  settings: {
    ...
    signal: {
      keySeqTitle: '记录按键序列',
      keySeqDesc: '高敏感：按时间顺序保存逻辑键名（非打字内容）。默认关闭，仅存本地，可设保留期并一键清除。',
      enableConfirmTitle: '开启按键序列记录？',
      enableConfirmBody: '将记录每分钟内按下的键名顺序，类似键位日志。不会上传。请确认你了解隐私风险。',
      enableConfirmOk: '仍然开启',
      retentionTitle: '序列保留时长',
      retentionDesc: '超时后自动清除序列明细（保留按键次数统计）',
      purgeTitle: '清除已存序列',
      purgeDesc: '立即删除本地全部按键序列明细',
      purgeBtn: '清除',
      purgeBody: '确定删除所有已存储的按键序列？此操作不可撤销。',
      purgeOk: '删除',
      purgeDone: '已清除 {n} 条记录中的序列',
      cancel: '取消',
    },
    eventSdk: {
      enableTitle: '启用外部 Event API',
      enableDesc: '本机 HTTP（127.0.0.1:23457）。关闭后拒绝写入，health 仍可探活。',
      ...
      rotate: '轮换',
      rotateTitle: '轮换访问令牌？',
      rotateBody: '旧令牌立即失效，已配置的脚本需更新 token。',
      rotateOk: '轮换',
      rotated: '令牌已轮换',
      cancel: '取消',
    },
    ...
    update: {
      ...
      hideDetails: '收起详情',
      sourceTitle: '更新源',
      sourceDesc: '检查更新和下载安装包走哪个 GitHub 镜像。自动会按顺序尝试。',
      source: '源',
      sourceAuto: '自动（依次尝试）',
      sourceGhfast: 'ghfast.top',
      sourceGhddlc: 'gh.ddlc.top',
      sourceGhproxy: 'ghproxy.net',
    ...
    agent: {
      ...
      hookTitle: 'Agent 联动',
      hookDesc: '一键写入 agent 的配置文件，让它把状态推送到 Catrace（Claude Desktop 与 Claude Code 共用配置，安装一次即覆盖）',
      installBtn: '安装 Hook',
      ...
      nameKimi: 'Kimi',
      eventsTitle: '事件通知策略',
      eventsDesc: '默认只对「需要你回来」的事件常驻；可按事件改成不通知 / 自动消失 / 常驻。',
      modeOff: '不通知',
      modeAuto: '自动消失',
      modeSticky: '常驻',
      eventSessionStart: '会话开始',
      eventUserPromptSubmit: '开始思考',
      eventStop: '任务完成',
      eventStopFailure: '任务出错 / 异常',
      eventNotification: '等待交互',
      soundTitle: '提示音',
      soundDesc: 'agent 通知弹出时播放的声音；自定义需填写本地音频文件绝对路径（wav / mp3 / ogg）',
      soundMode: '提示音模式',
      soundBuiltin: '内置',
      soundCustom: '自定义',
      soundMuted: '静音',
    ...
    messages: {
      ...
      silentOn: '已开启静默启动',
      silentOff: '已关闭静默启动',
      mediaActiveOn: '已开启媒体计入活跃',
      mediaActiveOff: '已关闭媒体计入活跃',
      notifySent: '通知已发送',
      notifyFailed: '通知失败',
      setFailed: '设置失败',
      noUpdate: '当前已是最新版本',
  ...
  debug: {
    ...
    signal: {
      ...
      seqOn: '有',
      seqOff: '无',
      empty: '暂无已落库分钟桶（运行满 1 分钟后出现）',
      hint: 'timestamp 为分钟结束；键序列内容不在此展示。每 2 秒刷新。',
    },
  },
  timeline: {
    active: '活跃',
  ...
  agent: {
    ...
    titleNotification: 'AI 助手需要你',
    titleDefault: 'AI 助手',
    bodyIdle: '会话已开始',
    bodyThinking: '正在处理你的请求',
    bodyAttention: '本轮任务已完成，等你继续',
    bodyError: '执行中断，请查看终端',
    bodyNotification: '需要你回来看一眼',
    bodyDefault: '状态已更新',
    titlePending: '{n} 个会话在等你',
    bodyPending: '{n} 个会话需要你处理',
    gotoSession: '点击前往会话',
    goto: '前往',
    moreCount: '还有 {n} 个会话，点击展开',
    dismissAll: '全部已读',
    unknownProject: '未知项目',
    // P6 权限审批卡
    permissionTitle: '等待你批准',
    permissionAllow: '允许',
    permissionDeny: '拒绝',
    permissionGoto: '前往终端',
  ...
  plugins: {
    ...
    rest: {
      ...
      pluginStatus: '插件状态',
      timingSection: '提醒偏好',
      timingSectionDesc: '设置久坐提醒的触发与重复节奏',
      windowTitle: '连续活跃时长',
      windowDesc: '连续活跃多久后提醒你休息',
      breakTitle: '有效休息时长',
      breakDesc: '连续休息多少分钟算一次有效休息',
      snoozeTitle: '重复提醒间隔',
      snoozeDesc: '活跃满后每隔多久提醒一次',
      previewDefaultTitle: '休息提醒',
      previewDefaultBody: '站起来休息一下吧。',
      testBtn: '发送测试提醒',
      methodSection: '提醒方式',
      contentSection: '提醒内容',
      contentSectionDesc: '自定义提醒弹窗中显示的标题与内容',
      modeTitle: '提醒模式',
      modeDesc: '选择久坐提醒的展示方式',
      modeToast: '通知提醒',
      modeFullscreen: '全屏提醒',
      customTitle: '提醒标题',
      customTitleDesc: '留空则使用默认标题',
      customBody: '提醒内容',
      customBodyDesc: '留空则使用默认内容',
      disabledHint: '已关闭久坐提醒。打开右上角开关后可配置提醒节奏与内容。',
      fullscreenBgTitle: '全屏背景图',
      fullscreenBgDesc: '选择一张图片作为全屏提醒背景',
      fullscreenOpacityTitle: '背景透明度',
      fullscreenOpacityDesc: '调整全屏背景遮罩的透明度',
    ...
    external: {
      ...
      installZip: '从 Zip 压缩包安装...',
      installing: '安装中…',
      installOk: '已安装 {name} v{version}，请手动启用',
      installOverwriteOk: '已覆盖安装 {name} v{version}',
      installOverwriteConfirm: '插件「{id}」已存在，是否覆盖安装？配置会保留，文件整包替换。',
      installFailed: '安装失败：{error}',
      installCancelled: '已取消安装',
      emptyHint: '点「安装插件」选择文件夹或 zip，或手动放入 plugins 目录后刷新。',
      enabled: '已启用',
      disabled: '已禁用',
      anomalous: '异常',
      noDescription: '无描述',
